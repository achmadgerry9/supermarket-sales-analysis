...
'''
# =======================================
# 10. Inspect Total mismatches
# =======================================

mismatch_mask = (
    df["total"].round(2) != expected_total.round(2)
)
...
mismatches["expected_total"] = (
    mismatches["cogs"] + mismatches["tax"]
).round(2)

mismatches["difference"] = (
    mismatches["total"] - mismatches["expected_total"]
).round(2)

print("\n" + "=" * 60)
print("TOTAL MISMATCH RECORDS")
print("=" * 60)
